...
```{r hgdiet, echo=FALSE, message=FALSE, warning=FALSE, fig.height=2.66667, fig.width=8, out.width='100%', fig.cap="A. The San peoples or Bushmen are indigenous hunter-gatherer cultures that are the first cultures of Southern Africa. Photo: [Aino Tuominen](https://ainotuominen.myportfolio.com/projects) (CC0). B. Diet composition of four hunter-gatherer communities, the Inuit of the high Arctic in Canada, the Hiwi of South America, the !Kung of southern Africa, and the Hadza of eastern Africa. [Data](data/12_diet.csv) from Leonard (2002)."}
...
```{r antpleim, echo=FALSE, message=FALSE, warning=FALSE, out.width='100%', fig.height=4, fig.width=8, fig.cap="A. Selection of either short or long lifespan  in *D. melanogaster* causes clear evolutionary responses in longevity. [Data](data/12_selection_longevity2.csv) form Zwaan et al. (1995). B. Evolution of longer lifespans coincides with drastic reductions in fecundity, indicateing antaginistic pleiotropic effects. [Data](data/12_selection_longevity3.csv) form Zwaan et al. (1995)."}
...
agenat.p2 <- ggplot(possum, aes(x=age, y=survival, color=habitat))+
    geom_point()+
    geom_line()+
    labs(x="Age [months]", y="Cumulative survival", color="Habitat")+
    theme_classic()+
