...
-   **Genealogical Species Concept:** A species is an exclusive group of organisms whose members more closely resemble one another than members of any outside group.
...
admix.p1 <- ggplot(admix1.2, aes(x=ind, y=probability, fill=cluster))+
    geom_bar(position="stack", stat="identity")+
    labs(x="Individual", y="Assignment probability", fill="Population")+
    theme_classic()+
...
admix.p3 <- ggplot(admix3.2, aes(x=ind, y=probability, fill=cluster))+
    geom_bar(position="stack", stat="identity")+
    labs(x="Individual", y="Assignment probability", fill="Assignment to")+
    theme_classic()+
