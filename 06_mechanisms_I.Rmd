...
```{r lactase, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Analyses of ancient DNA indicate an increase in the frequency of lactase persistence alleles starting about 5,000 years ago. Different geographic regions are color-coded and the size of markers is proportional to the number of genomes used to infer allele frequencies. [Data](data/5_lactase.csv) from Marciniak & Perry (2017)."}
