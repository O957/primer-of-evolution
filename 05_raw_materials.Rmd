...
```{r inversion, echo=FALSE, out.width='100%', fig.cap = "Inversions are caused when double breaks in the DNA (indicatesd by asterisks) are fixed upon a central element flipping in direction."}
